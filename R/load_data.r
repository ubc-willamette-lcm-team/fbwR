...
#
#   INPUTS:
#   infile : a string indicating the full file path to the workbook
#            The following sheet names are expected:
#               *_ELEV: elevation
#               *_OUT: total outflow
#               *_PH: powerhouse flow
#               *_RO: regulating outlet
#               *_SPILL: spillway flow
#   OUTPUTS:
#   a global variable, resvData, containing a list of reservoir-specific parameter lists 
#       (e.g., to get route effectiveness for Detroit, try: resvData$Detroit$RouteEffectiveness) 

loadResSim_FBWworkbook <- function(infile, wide = FALSE) {
